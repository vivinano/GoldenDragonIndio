...
echo"<div class='row'>
      <div class= 'col-md-8'>
      <img src='./goldimage/542.jpg' class='img-fluid' alt='welcome'>
     </div>
               
     
       <div class='jumbotron offset-md-1 col-md-3'>
       <h4>Welcome to Golden Dragon of Indio, CA</h4>
       <hr>
       <p style='font-size:12px'> Delicous Chinese Dishes for dining and takeout </p>
      <hr>";
...
echo "<div class='col-sm-3'>
       <table>
       <tr><th style='background-color:rgb(255,140,0);border:2px solid white;width:200px'>
       ".$r['OrderName']."";

			   
echo "</th></tr>
       <tr><td><img src='./goldimage/411.png' style='height:200px;width:200px' 
...
echo "<footer class='footer' style='margin-top:10px'>
      <div class='container' style='background-color:rgb(128,128,128);width:100%'>
       ...
       <div class='col-sm-5'>
       <p style='border-bottom:1px solid black;text-align:center;font-weight:bold'>
